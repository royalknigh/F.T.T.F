...
@Autonomous(name = "Auto Red Short BTC")
public class AutoRedShortBTC extends OpMode {
    ...
    private final Pose startPose    = new Pose(111, 137, Math.toRadians(0));
    private final Pose scorePose    = new Pose(90, 85,    Math.toRadians(0));

    private final Pose pickup1Pose    = new Pose(115, 85, Math.toRadians(0));

    private final Pose pickup2Pose    = new Pose(119, 67, Math.toRadians(0));
//    private final Pose openGateFirstPose   = new Pose(127, 67, Math.toRadians(0));
    private final Pose openGatePose   = new Pose(130, 67, Math.toRadians(0));

    private final Pose pickupGate     = new Pose(133, 57,  Math.toRadians(45));
    private final Pose scoreLeave     = new Pose(87, 97,  Math.toRadians(45));
...
//                break;
    ...
    public void buildPaths() {
        ...
        middleRow = follower.pathBuilder()
                ...
                .addPath(new BezierCurve(pickup2Pose, new Pose(118, 60), openGatePose))
...
//        middleRow2 = follower.pathBuilder()
        ...
        firstOpenGate = follower.pathBuilder()
                .addPath(new BezierCurve(openGatePose, new Pose(118, 68), scorePose))
                .setConstantHeadingInterpolation(scorePose.getHeading())
