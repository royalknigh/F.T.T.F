...
@Disabled
@Configurable
@Autonomous(name = "Auto Blue Short playoff Soft hoarders")
public class AutoBlueShortPlayoffSoft extends OpMode {
    ...
    public static double pickupX = 10, pickupY = 57, pickupHeading = 130;
